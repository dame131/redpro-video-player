...
public final class VaultActivity extends AppCompatActivity {
    ...
    private void showLockedScreen() {
        ...
        lockedView.setBackgroundColor(Color.BLACK);
    ...
    private void showVault() {
        LinearLayout root=new LinearLayout(this);root.setOrientation(LinearLayout.VERTICAL);root.setPadding(dp(14),dp(12),dp(14),dp(12));root.setBackgroundColor(Color.BLACK);
