...
public final class CloudImportActivity extends AppCompatActivity {
    ...
    @Override protected void onCreate(Bundle state) {
        ...
        root.addView(LuxuryIconView.create(this,R.drawable.icon_cloud_thick,"Cloud Import emblem"));TextView title=text("GOOGLE DRIVE & CLOUD",25,Color.WHITE);title.setContentDescription("Cloud Import Screen 17");root.addView(title);
