...
public final class PlaybackLabActivity extends AppCompatActivity {
 ...
 private LinearLayout screen(){
  ...
  cacheValue=text("",15,Color.WHITE);root.addView(cacheValue);root.addView(seek("NETWORK BUFFER",300,5000,prefs.getInt("vlc_network_cache",1500),(value)->{prefs.edit().putInt("vlc_network_cache",value).apply();cacheValue.setText("NETWORK BUFFER  "+value+" ms");}));cacheValue.setText("NETWORK BUFFER  "+prefs.getInt("vlc_network_cache",1500)+" ms");
